...
m.addCommand('3D and Deep/Coordinates', "nuke.nodePaste(\"" + os.path.join(Expression_path + "/Deep_3D/coordinates.nk") + "\")")
m.addCommand('3D and Deep/UV Map', "nuke.nodePaste(\"" + os.path.join(Expression_path + "/Deep_3D/UV_map.nk") + "\")")
