...
class TagGroups(QWidget):
    ...
    def __init__(self):
        ...
        #variables
        shots={"shot1":["Not Started",["#L Building","#A Low Angle","#S Medium Shot","#D West"]],"shot2":["Not Started",["#L Building","#A Low Angle","#S Top Shot","#D West"]],"shot3":["Approved",["#L Building","#A Low Angle","#S Medium Shot","#D South"]],"shot4":["In Progress",["#L Sea","#A Low Angle","#S Medium Shot","#D West"]],"shot8":["Not Started",["#L Building","#A Low Angle","#S Medium Shot","#D West"]],"shot9":["Not Started",["#L Building","#A Low Angle","#S Medium Shot","#D West"]],"shot10":["Approved",["#L Building","#A Low Angle","#S Medium Shot","#D West"]],"shot7":["In Progress",["#L Building","#A Low Angle","#S Medium Shot","#D West"]]}
        shotTags = ["#L Building","#A Low Angle","#S Medium Shot","#D West"]
            ...
            for header in headers:
                ...
                if header == "-Status":
                    for tag in statuses:
                        ...
                        if tag =="Not Started":
                            self.button.setText(self.button.text()+" "+str(ns))

                        if tag =="In Progress":
                            self.button.setText(self.button.text()+" "+str(ip))

                        if tag =="Approved":
                            self.button.setChecked(True)
                            self.button.setText(self.button.text()+" "+str(ap))
